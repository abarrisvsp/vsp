...
const D: Record<string, string> = {
  ...
  about_story_body: "Visionary Sound Productions is a full-service event production company headquartered in Commerce Township, Michigan. We've been at this since 2004. Long enough that many of our clients have been with us for more than a decade, and some have been with us since the beginning.\n\nWhen you call, text, or email, you'll speak directly with the owner. That's not a marketing line. It's how we've always run things, and it's the reason a wedding mother sends a thank-you about ceiling lights three weeks later, the reason a high school principal renews for the fourth year running.",
  ...
  about_time_3_year: '2013', about_time_3_text: 'Ten-year mark. Many of our earliest clients from back then are still with us today.',
