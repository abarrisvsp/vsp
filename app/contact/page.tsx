...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: row?.meta_description ?? 'Tell us about your event and hear back from Aaron within one business day. Lighting, sound, staging, and video across Metro Detroit and nationwide.',
